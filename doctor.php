            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <form id="frmdoctor" class="card">
                        ...
                        <div align="left">
                            <label for="" class="form-label">Doctor No</label>
                            <input type="text" class="form-control" placeholder="Doctor No" disabled id="dno" name="dno" size="30px" required>
                        </div>
                        ...
                        <br>
                        <div align="right" >
                            <button class="btn btn-info" id="save" type="button" onclick="addDoctor()">Add</button>
            ...
            function addDoctor(){
                if($("#frmdoctor").valid()){
                    ...
                    $.ajax({                        
                        ...
                        success:function(data){    
                            if(data == 2){
                                alert("Doctor Details already Addedd");
                            }else{
                                if(isNew == true){
                                alert("Doctor Addedd");
                                }else{
                                    alert("Doctor Updatedd");
                                }
                                getall();
                                //getAutoid();
                                $('#frmdoctor')[0].reset();
                                $('#dno').remouveAttr("disabled");                                   
                            }
                        }
                    });
                }
