                ...
                <div class="col-sm-4">
                    <form id="frmitem" class="card">
                        ...
                        <div align="left">
                            ...
                            <input type="text" class="form-control" placeholder="Item No" disabled id="ino" name="ino" size="30px" required>
                        </div>
                        ...
                        <br>
                        <div align="right" >
                            <button class="btn btn-info" id="save" type="button" onclick="addItem()">Add</button>
                    ...
                    success: function(data){
                        ...
                        $('#tbl-item').dataTable({
                            ...
                            "aoColumns" : [
                                ...
                                {"sTitle" : "Decription", "mData" : "description"},
                                {"sTitle" : "Sell Price", "mData" : "sellprice"},
                                {"sTitle" : "Buy Pricee", "mData" : "buyprice"},                                    
