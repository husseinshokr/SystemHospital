                ...
                <div class="col-sm-4">
                    <form id="frmuser" class="card">
                        ...
                        <div align="left">
                            ...
                            <select name="utype" id="utype" class="form-control" placeholder="UserType" required>
                        ...
                        <br>
                        <div align="right" >
                            <button class="btn btn-info" id="save" type="button" onclick="addUser()">Add</button>
